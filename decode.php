...
<br>
<form method="post"><br>
<textarea class='inputz' cols=50 rows=15 name="mbutt" style="background:transparent;color:aqua;"></textarea><br><br>
...
echo "<from><center><h3><font size=4 color=aqua>HASIL</h3></center><textarea cols=50 rows=15 style='onfocus();font-weight:bold;color:red;background-image: transparent;opacity:0.40;background-size:100%;background-repeat: no-repeat;' class='inputz' readonly>".$html."</textarea><BR/><BR/></center></from>";
?>
</html>
